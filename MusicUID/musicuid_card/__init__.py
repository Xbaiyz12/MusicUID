            ...
            },
            {
                ...
                "commands": [
                    ...
                    },
                    {
                        ...
                        "desc": "设置 QQ 音乐 Cookie（发送「QQ音乐cookie」可看教程）",
                        "tag": "快捷配置",
                        "tag_type": "",
                    },
                    {
                        "cmd": "设置cookie 平台 <Cookie值>",
                        "desc": "手动绑定指定平台 Cookie 凭据（如 qq/网易云/酷狗）",
                        "tag": "通用配置",
                        "tag_type": "",
                    },
                    {
                        "cmd": "点歌状态 / 点歌登录状态",
                        "desc": "查询网易云、QQ 音乐、酷狗三平台的凭据绑定状态",
                        "tag": "状态查询",
                        "tag_type": "",
                    },
                    {
                        "cmd": "点歌加白 <用户ID/@用户>",
                        "desc": "授权指定用户使用平台登录与凭据配置权限（主人可用）",
                        "tag": "主人权限",
                        "tag_type": "perm",
                    },
                    {
