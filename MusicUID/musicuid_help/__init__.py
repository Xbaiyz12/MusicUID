...
点歌 QQ 关键词     临时切换指定平台（网易/QQ/酷狗）
播放 关键词        搜索并直接发送第一首歌曲语音/音频
听N                播放当前搜索列表第 N 首（如听1、听2）
歌词 关键词        查看歌曲完整歌词

【扫码登录（免手填 Cookie，主人/白名单）】
网易云登录 / 点歌登录 网易云    手机扫码一键登录网易云（解锁 VIP 与无损）
酷狗登录 / 点歌登录 酷狗        手机扫码一键登录酷狗音乐
点歌登录 / 音乐登录            查看登录平台菜单与引导
点歌状态 / 点歌登录状态        查看三平台凭证配置状态

【Cookie 快捷配置（针对 QQ音乐 等）】
QQ音乐cookie <Cookie值>        直接设置 QQ 音乐 Cookie
设置cookie 平台 <Cookie值>     手动绑定任意平台 Cookie
（发送「QQ音乐cookie」可查看超简单获取教程）
